import{d as J,r as dt,g as P,e as pt,f as ct,h as ut,i as mt,j as ft,k as ht,l as bt,m as vt,n as gt,o as xt,p as yt,q as wt}from"./dungeon-PnaD68Cx.js";import{p as $t}from"./gamepack-qvEGmjX8.js";import{C as A}from"./tables-ZTJnINVt.js";import{T as kt}from"./tables-doc-77epHSrL.js";import{f as V,p as _t,a as Lt,g as K,b as F,u as St,E as Tt,s as jt,o as Mt,t as Pt,d as Z}from"./tuner-core-ksL6lNIe.js";import{r as zt,h as Ot}from"./stale-card-dWmkVAXj.js";import{o as Ct}from"./ui-confirm-zRMDo5pK.js";import{e as Ht,t as o}from"./world-ui-D8L0z2Uf.js";import"./play-input-CvHBVnfg.js";import"./status-BFngDnvf.js";import"./three.module-BAT99Nro.js";import"./draft-play-channel-CYsjf8sq.js";const Et=`<!-- ============================================================
...
`,c=g=>g.replace(/[&<>"]/g,T=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[T]),Y=()=>new Date().toISOString().replace(/\.\d+Z$/,"Z");try{const g=Object.assign({"../../tenants/masaru/comduct/prefabs/deep-throne.json":yt,"../../tenants/masaru/comduct/prefabs/interior-craft.json":xt,"../../tenants/masaru/comduct/prefabs/interior-equip.json":gt,"../../tenants/masaru/comduct/prefabs/interior-heal.json":vt,"../../tenants/masaru/comduct/prefabs/interior-recruit.json":bt,"../../tenants/masaru/comduct/prefabs/interior-shop.json":ht,"../../tenants/masaru/comduct/prefabs/manifest.json":ft,"../../tenants/masaru/comduct/prefabs/root-den.json":mt,"../../tenants/masaru/comduct/prefabs/scribe-alcove.json":ut,"../../tenants/masaru/comduct/prefabs/shrine-guardian.json":ct}),T=[];for(const w of Object.keys(g).sort())w.endsWith("manifest.json")||T.push($t(g[w].default??g[w]));wt(T)}catch(g){console.warn("truth プレハブの読込に失敗（プレハブ無しの束見で継続）",g)}const Nt={tuning:A.tuning,gen:A.genParams,gim:A.gimmicks},Kt={id:"tuner",async mount(g,T){const{wapi:w,postJson:C}=T.api;g.innerHTML=Et,Ht(g);const s=a=>g.querySelector(`#${a}`);function b(a,t=!1){const e=s("msg");e.textContent=a,e.style.color=t?"#ff7a6e":"#7fd17f"}let p=V(),x="curve",$="trap",u=3,O={};function H(){return Mt(p)}const D="cdTunerW2";function j(){try{sessionStorage.setItem(D,JSON.stringify({v:1,draft:p,tab:x,selGim:$,depth:u,seed:s("seedbase").value,count:s("count").value,label:s("savelabel").value}))}catch{}}function Q(){var a,t;try{const e=sessionStorage.getItem(D);if(!e)return!1;const n=JSON.parse(e);return n.v!==1||!((a=n.draft)!=null&&a.genParams)||!((t=n.draft)!=null&&t.gimmicks)?!1:(p=n.draft,x=n.tab??"curve",$=n.draft.gimmicks[n.selGim]?n.selGim:"trap",u=Math.max(1,Math.min(30,n.depth|0||3)),s("depth").value=String(u),s("depthv").textContent=`${u}F`,n.seed&&(s("seedbase").value=n.seed),n.count&&(s("count").value=n.count),n.label&&(s("savelabel").value=n.label),!0)}catch{return!1}}const f=(a,t,e,n,i=1,m="num")=>{const r=a.split(".").reduce((d,k)=>d==null?void 0:d[k],Nt);return`<input class="${m}${typeof r=="number"&&r!==t?" chg":""}" data-f="${a}" type="number" value="${t}" min="${e}" max="${n}" step="${i}" />`};function v(){const a=s("form");if(x==="curve"){const n=p.genParams,i=K(n,u),m=Object.keys(p.gimmicks).map(r=>{const l=p.gimmicks[r];return`<tr data-gim="${r}" class="${r===$?"sel":""}">
            ...
            <td class="sub">${Math.round(F(l,u)*100)}%</td>
          </tr>`}).join("");a.innerHTML=`
