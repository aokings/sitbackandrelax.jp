import{p as j,o as De}from"./ui-confirm-zRMDo5pK.js";import{e as Oe,a as B,t as o,D as Le,w as $,n as _e,m as We}from"./world-ui-D8L0z2Uf.js";import{e as G,d as q,S as $e,f as we,g as me,j as Ee,h as Se,l as Ue,i as Be,k as Ce,a as ue,m as Ge,n as be,s as ee,L as fe,o as Ne,p as qe}from"./studio-CSAopwfS.js";import{r as Je,h as Ve}from"./stale-card-dWmkVAXj.js";import{T as Ye}from"./tables-doc-77epHSrL.js";import{o as Ke}from"./testbed-BSwAzymV.js";import"./status-BFngDnvf.js";import"./modulepreload-polyfill-B5Qt9EMX.js";import"./tables-ZTJnINVt.js";import"./render-voxel-B1ERWxhq.js";import"./three.module-BAT99Nro.js";import"./play-input-CvHBVnfg.js";import"./dungeon-PnaD68Cx.js";import"./gamepack-qvEGmjX8.js";import"./draft-play-channel-CYsjf8sq.js";import"./playtest-core-wASw7fFi.js";import"./tuner-core-ksL6lNIe.js";const Xe=`<!-- ============================================================
...
`,m=F=>F.replace(/[&<>"]/g,y=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[y]),Te=()=>new Date().toISOString().replace(/\.\d+Z$/,"Z"),Ze=[["worlds.laws.g.pos",["posBack","posSide","posHigh"]],["worlds.laws.g.wave",["waveFirstAfter","waveGapBase","waveGapJitter","waveCountCap"]],["worlds.laws.g.cap",["monsterCap"]],["worlds.laws.g.breath",["breathLen","breathCd"]]],ft={id:"worlds",async mount(F,y){F.innerHTML=Xe,Oe(F);const s=e=>F.querySelector(`#${e}`);function f(e,t=!1){const n=s("say");n.textContent=e,n.className=t?"err":""}let te="masaru",N=[],E=!1,k="fork",ae=Le;function J(){for(const e of Array.from(F.querySelectorAll(".tplcard")))e.classList.toggle("on",e.dataset.tpl===k);s("fldFromLbl").hidden=k!=="from"}s("tplRow").addEventListener("click",e=>{const t=e.target.closest(".tplcard");t!=null&&t.dataset.tpl&&(k=t.dataset.tpl,J())});function oe(e,t){if(t===y.world()){y.navigate(e);return}const n=y.standalone?new URL("studio.html",window.location.href):new URL(window.location.href);n.search="",n.searchParams.set("panel",e),n.searchParams.set("world",t),window.location.href=n.toString()}function ne(){var d,r;const e=s("worlds");if(e.innerHTML="",!N.length){const l=document.createElement("div");if(l.className="live",l.textContent=o("worlds.none"),e.appendChild(l),!E&&B()!==""){const p=document.createElement("a");p.className="btn on",p.target="_blank",p.rel="noopener",p.href=We(B(),"worlds"),p.textContent=`🐙 ${o("worlds.hostedCta")}`,e.appendChild(p)}if(E){const p=document.createElement("button");p.type="button",p.className="on",p.textContent=o("worlds.emptyCta"),p.addEventListener("click",()=>{s("fldId").focus();const L=s("wapp");L.scrollTo({top:L.scrollHeight,behavior:"smooth"})}),e.appendChild(p)}return}for(const l of N){const p=document.createElement("div");p.className="card";const L=document.createElement("div"),ye=document.createElement("b");ye.textContent=l.title,L.appendChild(ye);const re=document.createElement("div");re.className="key",re.textContent=l.key;const Y=document.createElement("div");Y.className="tagrow";const de=document.createElement("span");de.className="tag"+(l.publishedAt?" pub":""),de.textContent=l.publishedAt?o("worlds.statusPublished"):o("worlds.statusDraft"),Y.appendChild(de);const ke=l.forkedFrom;if(ke){const i=document.createElement("span");i.className="tag",i.textContent=o("worlds.forkedFrom",{world:ke}),Y.appendChild(i)}p.append(L,re,Y);const ie=document.createElement("div");ie.className="row";for(const i of qe){if(i.id==="worlds")continue;const b=document.createElement("button");b.type="button",b.className="btn",b.textContent=`${i.icon} ${o(i.titleKey)}`,b.addEventListener("click",()=>oe(i.id,l.key)),ie.appendChild(b)}p.appendChild(ie);const pe=document.createElement("div");pe.className="row";const P=document.createElement("button");P.type="button",P.className="on",P.textContent=o("worlds.publish"),P.addEventListener("click",()=>{(async()=>{try{const i=await j("/api/worlds/publish",{world:l.key});f(o("worlds.published",{path:i.packPath})),await A()}catch(i){f(o("worlds.publishFail",{msg:i.message}),!0)}})()});const K=document.createElement("button");K.type="button",K.textContent=o("tool.common.dup"),K.addEventListener("click",()=>{k="from",J(),s("fldFrom").value=l.key,s("fldId").focus();const i=s("wapp");i.scrollTo({top:i.scrollHeight,behavior:"smooth"})});const D=document.createElement("a");D.className="btn",D.textContent=o("worlds.play"),D.href=`dungeon.html?pack=${encodeURIComponent(`packs/${l.packName}.json`)}`,D.target="_blank";const X=l,Z=document.createElement("button");Z.type="button",Z.textContent=o("worlds.editMeta");const I=document.createElement("div");I.className="metaedit",I.style.display="none";const O=document.createElement("input");O.type="text",O.value=l.title,O.placeholder=o("worlds.metaTitle");const H=document.createElement("textarea");H.value=X.description??"",H.placeholder=o("worlds.metaDesc"),H.maxLength=280,H.rows=2;const _=document.createElement("input");_.type="text",_.value=(X.tags??[]).join(" "),_.placeholder=o("worlds.metaTags");const ce=document.createElement("div");ce.className="coverpick";const Q=document.createElement("select");for(const i of["prefab","monster","model"]){const b=document.createElement("option");b.value=i,b.textContent=o(`worlds.cover.${i}`),Q.appendChild(b)}Q.value=((d=X.cover)==null?void 0:d.kind)??"prefab";const W=document.createElement("input");W.type="text",W.value=((r=X.cover)==null?void 0:r.id)??"",W.placeholder=o("worlds.metaCover"),ce.append(Q,W);const U=document.createElement("button");U.type="button",U.className="on",U.textContent=o("worlds.metaSave"),U.addEventListener("click",()=>{(async()=>{try{const i=_.value.trim(),b=i?i.toLowerCase().split(/[\s,]+/).filter(Boolean):null,T=W.value.trim(),Pe=T?{kind:Q.value,id:T}:null;await j("/api/worlds/meta",{world:l.key,title:O.value.trim()||void 0,description:H.value.trim()||null,tags:b,cover:Pe}),f(o("worlds.metaSaved")),await A()}catch(i){f(i.message,!0)}})()}),I.append(O,H,_,ce,U),Z.addEventListener("click",()=>{I.style.display=I.style.display==="none"?"flex":"none"});const R=document.createElement("button");R.type="button",R.textContent=o("worlds.playtest"),R.addEventListener("click",()=>{(async()=>{R.disabled=!0,f(o("worlds.playtestRun"));try{const i=(()=>{try{return localStorage.getItem("comduct-creator-token")}catch{return null}})(),b=await fetch(`${B()}/api/worlds/playtest?world=${encodeURIComponent(l.key)}&seeds=8&turns=200`,i?{headers:{authorization:`Bearer ${i}`}}:void 0);if(!b.ok){f(o("worlds.playtestFail",{code:String(b.status)}),!0);return}const T=(await b.json()).aggregate;f(o("worlds.playtestResult",{surv:(T.survivalRate*100).toFixed(0),depth:T.meanDepth.toFixed(1),turns:T.meanTurns.toFixed(0),hp:T.meanHeroHp.toFixed(1)}))}catch(i){f(i.message,!0)}finally{R.disabled=!1}})()}),pe.append(P,K,D,Z,R),p.append(pe,I),e.appendChild(p)}const t=s("fldFrom"),n=t.value;t.innerHTML="";const a=document.createElement("option");a.value="",a.textContent=o("worlds.fromEmpty"),t.appendChild(a);for(const l of N){const p=document.createElement("option");p.value=l.key,p.textContent=`${l.title}（${l.key}）`,t.appendChild(p)}[...t.options].some(l=>l.value===n)&&(t.value=n)}function se(){s("acct").textContent=E?te:o("worlds.acctLocal"),s("acctNote").textContent=E?o("worlds.acctNote",{n:N.length}):""}async function A(){const e=await _e();if(!e){B()!==""?f(o("worlds.hostedNeed")):f(o("worlds.loadFail",{msg:"API unreachable"}),!0),E=!1,N=[],se(),ne();return}E=!0,te=e.accountId,N=e.worlds,ae=e.defaultWorldKey??Le,se(),ne()}s("createForm").addEventListener("submit",e=>{if(e.preventDefault(),!E&&B()!==""){f(o("worlds.hostedNeed"),!0);return}const t=s("fldId").value.trim(),n=s("fldTitle").value.trim()||t,a=k==="fork"?ae:k==="from"?s("fldFrom").value:void 0;if(k==="from"&&!a){f(o("worlds.tpl.fromNeed"),!0);return}(async()=>{try{const d=await j("/api/worlds",{id:t,title:n,...a?{from:a}:{}});f(o("worlds.created",{key:d.key}));const r=document.createElement("button");r.type="button",r.className="on",r.style.marginLeft="8px",r.textContent=o("worlds.openNew",{key:d.key}),r.addEventListener("click",()=>oe("hub",d.key)),s("say").appendChild(r),s("fldId").value="",s("fldTitle").value="",await A()}catch(d){f(o("worlds.createFail",{msg:d.message}),!0)}})()});let x="home",w=G(),c=q(),g=!1,h=null;function u(e,t=!1){const n=s("lawsSay");n.textContent=e,n.className=t?"err":"",n.style.color=t?"#e08a8a":"#8fd6a3"}function M(){s("wtab-home").classList.toggle("on",x==="home"),s("wtab-laws").classList.toggle("on",x==="laws"),s("whome").hidden=x!=="home",s("wlaws").hidden=x!=="laws"}const xe="cdWorldsLawsM6";function v(){try{sessionStorage.setItem(xe,JSON.stringify({v:2,tab:x,laws:w,sys:c,dirty:g,label:s("lawsLabel").value}))}catch{}}function Fe(){var e,t;try{const n=sessionStorage.getItem(xe);if(!n)return!1;const a=JSON.parse(n);if(a.v!==1&&a.v!==2||typeof((e=a.laws)==null?void 0:e.monsterCap)!="number")return!1;x=a.tab==="laws"?"laws":"home";const d=G();for(const l of fe)typeof a.laws[l]=="number"&&(d[l]=a.laws[l]);w=d;const r=q();for(const[,l]of Ne)for(const p of l){const L=(t=a.sys)==null?void 0:t[p];L!=null&&typeof L==typeof r[p]&&(r[p]=L)}return c=r,g=!!a.dirty,a.label&&(s("lawsLabel").value=a.label),!0}catch{return!1}}function S(){const e=G();s("lawsForm").innerHTML=Ze.map(([t,n])=>`<div class="lawgrp"><h3>${m(o(t))}</h3>${n.map(a=>{const d=Ge[a];return`<div class="lawrow"><code>${a}</code><span class="lbl">${m(o(`worlds.laws.f.${a}`))}</span><input data-law="${a}" type="number" value="${w[a]}" min="${d.min}" max="${d.max}" step="${d.step}" class="${w[a]!==e[a]?"chg":""}" /><span class="rng">${d.min}–${d.max}</span></div>`}).join("")}</div>`).join(""),Ie(),V(),le()}function ze(e){const t=$e[e],n=c[e]!==q()[e],a=`<code>${e}</code><span class="lbl">${m(o(`worlds.laws.sys.f.${e}`))}</span>`;if(t.kind==="toggle")return`<div class="lawrow${n?" chg":""}">${a}<input data-sys="${e}" type="checkbox"${c[e]?" checked":""} /></div>`;if(t.kind==="enum"){const d=(t.options??[]).map(r=>`<option value="${r}"${c[e]===r?" selected":""}>${m(o(`worlds.laws.sys.opt.${e}.${r}`))}</option>`).join("");return`<div class="lawrow${n?" chg":""}">${a}<select data-sys="${e}" class="${n?"chg":""}">${d}</select></div>`}return`<div class="lawrow">${a}<input data-sys="${e}" type="number" value="${c[e]}" min="${t.min}" max="${t.max}" step="${t.step}" class="${n?"chg":""}" /><span class="rng">${t.min}–${t.max}</span></div>`}function Ie(){s("sysForm").innerHTML=Ne.map(([e,t])=>`<div class="lawgrp"><h3>${m(o(`worlds.laws.sys.g.${e}`))}</h3>${t.map(ze).join("")}</div>`).join("")}function V(){const e=s("lawsLint"),t=s("lawsSave"),n=[...Ue(w),...Be(c)];if(n.length)return e.innerHTML=`<div class="err">${n.map(a=>m(o("worlds.laws.rangeErr",{field:a.field,min:a.min,max:a.max}))).join(`
`)}</div>`,t.disabled=!0,!1;try{we(me({},w),c)}catch(a){return e.innerHTML=`<div class="err">✗ ${m(a.message.slice(0,600))}</div>`,t.disabled=!0,!1}return e.innerHTML=`<div class="ok">✓ ${m(o("worlds.laws.lintOk",{n:Ce(w).length+ue(c).length}))}</div>`,t.disabled=!1,!0}function le(){const e=Se(w),t=Ee(c),n=[...e.notes,...t.notes],a=n.some(r=>r.level==="warn")?"warn":n.length?"note":"ok",d=o(a==="ok"?"worlds.laws.meterOk":a==="note"?"worlds.laws.meterNote":"worlds.laws.meterWarn");s("lawsMeter").innerHTML=`<div class="meter ${a}"><b class="lv">${m(d)}</b>${n.length?`<ul>${n.map(r=>`<li>${m(o(`worlds.laws.n.${r.key}`))}</li>`).join("")}</ul>`:""}</div>`}function ge(e){var d;const t=s("lawsTruth");if(!e){t.innerHTML=`<div class="live">${m(o("worlds.laws.truthEmpty"))}</div>`;return}const n=fe.filter(r=>{var l;return typeof((l=e.tables.tuning)==null?void 0:l[r])=="number"}).length+(e.tables.systems?ue(ee(e.tables)).length:0),a=[...Object.keys(e.tables).filter(r=>r!=="tuning"&&r!=="systems"),...Object.keys(e.tables.tuning??{}).filter(r=>!fe.includes(r)).map(r=>`tuning.${r}`)];t.innerHTML=`<div class="card"><b>${m(e.name)}</b><span class="id">${m(e.updatedAt)}・${n} ${m(o("worlds.laws.ovFields"))}</span><span class="id">${m(a.length?o("worlds.laws.keepNote",{list:a.join(", ")}):o("worlds.laws.keepNone"))}</span><div class="row"><button type="button" data-act="laws-truth-load">${m(o("worlds.laws.load"))}</button></div></div>`,(d=t.querySelector('[data-act="laws-truth-load"]'))==null||d.addEventListener("click",()=>{w=be(e.tables),c=ee(e.tables),g=!1,S(),u(o("worlds.laws.loaded",{name:e.name})),v()})}async function C(){var e;s("lawsWorld").textContent=y.world();try{const[t,n]=await Promise.all([fetch($("/api/tables/truth")).then(a=>a.json()),fetch($("/api/tables/proposals")).then(a=>a.json())]);h=((e=t.docs)==null?void 0:e[0])??null,g||(w=be((h==null?void 0:h.tables)??{}),c=ee((h==null?void 0:h.tables)??{}),S()),ge(h),Je(s("lawsProposals"),n.proposals??[],{tag:()=>o("worlds.laws.capTag"),onView:a=>{he(a)},onPromote:a=>{He(a)},onArchive:a=>{Re(a)}})}catch{h=null,s("lawsTruth").innerHTML=`<div class="live">${m(o("worlds.laws.noApi"))}</div>`,s("lawsProposals").innerHTML=""}}async function he(e){var t;try{const a=(t=(await(await fetch($(`/api/tables/proposal?id=${encodeURIComponent(e)}`))).json()).docs)==null?void 0:t[0];if(!a)throw new Error("proposal is empty");w=be(a.tables),c=ee(a.tables),g=!0,S(),u(o("worlds.laws.loaded",{name:a.name})),v()}catch(n){u(n.message,!0)}}async function He(e){try{await j($("/api/tables/promote"),{proposalId:e}),u(o("tool.common.adoptedNote")),C()}catch(t){if(Ve(t,{base:"/api/tables",wapi:$,proposalId:e,onView:()=>{he(e)},onRebased:()=>{u(o("tool.conflict.rebased")),C()}}))return;u(o("tool.common.promoteFail",{msg:t.message}),!0)}}async function Re(e){try{await j($("/api/tables/archive"),{proposalId:e}),u(o("tool.common.archived")),C()}catch(t){u(o("tool.common.archiveFail",{msg:t.message}),!0)}}async function ve(){var r;if(!V()){u(o("worlds.laws.saveNoValid"),!0);return}let e=h;try{e=((r=(await(await fetch($("/api/tables/truth"))).json()).docs)==null?void 0:r[0])??null}catch{}let t;try{t=we(me((e==null?void 0:e.tables)??{},w),c)}catch(l){u(l.message,!0);return}const n=[...Ce(w),...ue(c)],a=s("lawsLabel").value.trim()||o("worlds.laws.defaultLabel",{list:n.length?n.join(", "):"—"}),d={formatVersion:Ye,id:"tables",name:a,tables:t,createdAt:(e==null?void 0:e.createdAt)??Te(),updatedAt:Te()};try{await j($("/api/tables/proposal"),{tables:d,label:a,createdBy:"user"}),u(o("worlds.laws.saved",{name:a})),C()}catch(l){u(o("tool.common.saveFail",{msg:l.message}),!0)}}s("wtab-home").addEventListener("click",()=>{x="home",M(),v()}),s("wtab-laws").addEventListener("click",()=>{x="laws",M(),v()}),s("lawsForm").addEventListener("input",e=>{const t=e.target,n=t.getAttribute("data-law");n&&(w[n]=Number(t.value),g=!0,t.classList.toggle("chg",w[n]!==G()[n]),V(),le(),v())}),s("sysForm").addEventListener("input",e=>{var l;const t=e.target,n=t.getAttribute("data-sys");if(!n)return;const a=$e[n],d=c;a.kind==="toggle"?d[n]=t.checked:a.kind==="enum"?d[n]=t.value:d[n]=Number(t.value),g=!0;const r=c[n]!==q()[n];a.kind!=="toggle"&&t.classList.toggle("chg",r),(l=t.closest(".lawrow"))==null||l.classList.toggle("chg",r),V(),le(),v()}),s("lawsSave").addEventListener("click",()=>{ve()});const z=document.createElement("button");z.type="button",z.id="lawstry",z.textContent="▶ 死→蘇生を試す",z.title="仲間を死体にして蘇生を詠唱→この revive dial（成功率/灰）で復帰するか確かめる",s("lawsSave").insertAdjacentElement("afterend",z),z.addEventListener("click",()=>{try{const e=we(me({},w),c).systems??{};Ke("systems",e,y.world()).catch(t=>u(t.message,!0))}catch(e){u(e.message,!0)}}),s("lawsReset").addEventListener("click",()=>{w=G(),c=q(),g=!0,S(),u(o("worlds.laws.resetDone")),v()});const je=y.events.on("tables",()=>{C()});window.cdWorlds={reload:()=>A(),worlds:()=>N,account:()=>te,apiOk:()=>E,api:e=>$(e),open:(e,t)=>oe(e,t??y.world()),tpl:e=>(e&&(k=e,J()),k),flagship:()=>ae,laws:{tab:e=>{x=e,M()},draft:()=>({...w}),set:(e,t)=>{w[e]=t,g=!0,S(),v()},judge:()=>Se(w),sysDraft:()=>({...c}),setSys:(e,t)=>{c[e]=t,g=!0,S(),v()},judgeSys:()=>Ee(c),save:()=>ve(),refresh:()=>C()}};const Ae=De(()=>{se(),ne(),S(),ge(h),C()}),Me=Fe();return M(),J(),S(),Me&&g&&u(o("tool.common.restored")),A(),C(),{applyParams(e){const t=e.get("tab");t==="laws"?x="laws":t==="home"&&(x="home"),M()},dispose(){je(),Ae(),v(),delete window.cdWorlds}}}};export{ft as worldsPanel};
