...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Sl(){return new gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:rr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function yl(){return new gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rr(),fragmentShader:`
...
`].filter(Qi).join(`
`)),a=za(a),a=Ll(a,t),a=Il(a,t),o=za(o),o=Ll(o,t),o=Il(o,t),a=Ul(a),o=Ul(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+p);const w=b+m+a,S=b+p+o,C=Cl(s,s.VERTEX_SHADER,w),A=Cl(s,s.FRAGMENT_SHADER,S);s.attachShader(v,C),s.attachShader(v,A),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function D(y){if(i.debug.checkShaderErrors){const R=s.getProgramInfoLog(v)||"",L=s.getShaderInfoLog(C)||"",G=s.getShaderInfoLog(A)||"",I=R.trim(),k=L.trim(),B=G.trim();let Z=!0,Q=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,C,A);else{const re=Dl(s,C,"vertex"),ie=Dl(s,A,"fragment");He("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
