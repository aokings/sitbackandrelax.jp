import{B as xe,r as we,$ as ye,G as kt,W as Qt,S as Zt,P as jt,t as ke,D as Mt,A as Me,H as Ee,a as Le,N as Se,a0 as ze,_ as Te,a1 as Ae,u as Et,M as ot,O as Pe,l as Lt,a2 as te,E as ee,z as Ce,C as ne,s as St,V as C,w as $e,x as He,y as Ie,m as Oe,L as De,Y as Re,X as _e,Z as Fe,U as Ne,a3 as Ge,a4 as Be,a5 as ae,a6 as qe,a7 as Ve,a8 as We}from"./render-voxel-Cyel61y7.js";import{C as Ue,I as oe,p as Xe,k as Ye,M as Ke,R as Je}from"./dungeon-sINRkXwK.js";import{a as Qe}from"./touch-input-D1HYJrcI.js";import{o as Ze}from"./shell-D-WKfnWk.js";import{b as je,t as k,c as $}from"./i18n-CUpE17Zf.js";import{D as tn}from"./creator-auth-C9Tw5ccD.js";import{g as en,a as nn,v as an}from"./voxmodel-E5X6LCJx.js";import"./preload-helper-Dp1pzeXC.js";import"./prefab-CaEyAM_B.js";import"./schemas-BBGxizon.js";import"./tables-Du__anr4.js";const on=`<!-- ============================================================
...
`,sn=Ue.flatMap(l=>l.out==="item"?[l.item]:[]),st=[...oe,...sn.filter(l=>!oe.some(m=>m.id===l.id))],F=l=>st.find(m=>m.id===l),ln=st.filter(l=>l.kind==="weapon"),rn=st.filter(l=>l.kind==="armor"),cn=st.filter(l=>l.kind==="accessory"),it=l=>{var m;return((m=l.nameOf)==null?void 0:m.call(l))??l.name},ie={"床・壁・地形":"tool.catalog.cat.tiles",敵:"tool.catalog.cat.mons","仲間・自機":"tool.catalog.cat.figs"},dn=new xe(1,1,1);function zt(l){const m=De(l);if(Re().some(M=>M.id===m))return`<b>data/models/${m}.json</b>（truth モデル＝<b>sculpt.html</b> で彫る・灯りも data の glow）／dungeon.ts MONSTERS（能力）`;const d=_e[m]?`／<b>GLOW_HEX['${m}']</b>（灯り）`:"";return Fe[m]?`render-voxel.ts <b>LARGE_BUILDERS['${m}']</b>（GB 彫刻）${d}／dungeon.ts MONSTERS（能力）`:Ne[m]?`render-voxel.ts <b>MON_VOX['${m}']</b>（スライス定義・sculpt.html で取り込み可）${d}／dungeon.ts MONSTERS（能力）`:`render-voxel.ts <b>monsterBoxes()</b> の t==='${m}' 分岐${d}／dungeon.ts MONSTERS（能力）`}const pn="render-voxel.ts <b>figureBoxes()</b>／<b>raceSpecOf()</b>（種族差）＋ dungeon-types.ts <b>weaponVisual/armorVisual/accVisual</b>（装備→見た目）＋ dungeon.ts ITEM_POOL/CRAFT_RECIPES（台帳）",Mn={id:"catalog",async mount(l,m){l.innerHTML=on,je(l);const d=t=>l.querySelector(`#${t}`);let M="plain",E="live",J=!1,h=null,u=null,c=null,v=null,x=null,b=null;const se=new we(document.createElement("div"),()=>{});function Q(t){const{geo:e,spots:n}=$e(t),a=new kt,o=t.kind==="monster"&&He(t)?Ie(t)/100:1;{const i=new ot(e,Oe());o!==1&&i.scale.setScalar(o),a.add(i)}for(const i of n){const p=new ot(dn,new Lt({color:i.c}));p.position.set(i.x*o,i.y*o,i.z*o),p.scale.set(i.sx*o,i.sy*o,i.sz*o),p.userData.sp=i,p.userData.bk=o,a.add(p)}return a}const f=[];for(const t of ye)f.push({id:"tile:"+t.id,name:t.name,cat:"床・壁・地形",hint:`${t.hint}／テーマ色は <b>ENV['THEME']</b>`,nameOf:()=>k(`tool.catalog.tile.${t.id}`),build:()=>{const e=se.buildSample(M,t.id);e.position.set(-1,0,-1);const n=new kt;return n.add(e),n}});const lt=(t,e={})=>({kind:"monster",name:t,color:"#e07a44",equipment:{},stats:{},pos:{x:0,y:0},facing:{dx:0,dy:1},...e});function Tt(){for(let e=f.length-1;e>=0;e--)f[e].cat==="敵"&&f.splice(e,1);const t=[];for(const e of Ke){const n=lt(e.name,{size:e.size,heads:e.heads,element:e.element});t.push({id:"mon:"+e.name,name:e.name+(e.size?`（${e.size}×${e.size}）`:""),cat:"敵",hint:zt(n),nameOf:()=>$(e.name)+(e.size?`（${e.size}×${e.size}）`:""),build:()=>Q(n),actor:n,anim:!0})}for(const e of["fire","ice","earth","holy"]){const n={fire:"火",ice:"氷",earth:"土",holy:"聖"}[e],a=lt(`${n}の術士`,{element:e});t.push({id:"mon:caster-"+e,name:`${n}の術士`,cat:"敵",hint:zt(a),nameOf:()=>$(`${n}の術士`),build:()=>Q(a),actor:a,anim:!0})}for(const[e,n]of[["番兵",{}],["魔物の巣",{}],["封印のボス",{size:2,heads:2}]]){const a=lt(e,n);t.push({id:"mon:"+e,name:e,cat:"敵",hint:zt(a),nameOf:()=>$(e),build:()=>Q(a),actor:a,anim:!0})}f.push(...t)}Tt();const L=(t,e,n,a,o,i,p,s,r=7)=>{const Y={kind:n,race:a,color:o,pos:{x:0,y:0},facing:{dx:0,dy:1},stats:{pie:r},equipment:{weapon:i?F(i):void 0,armor:p?F(p):void 0,accessory:s?F(s):void 0}};return{id:"fig:"+t,name:t,cat:"仲間・自機",hint:pn,nameOf:()=>k(e),build:()=>Q(Y),actor:Y,dress:!0,anim:!0}};f.push(L("主人公（鋼の剣・鉄鎧）","tool.catalog.fig.hero","hero","human","#ffd24a","steel","iarmor"),L("ハーフットの斥候（毒の刃・革鎧）","tool.catalog.fig.scout","ally","halffoot","#46c7bf","venomblade","larmor"),L("ドワーフの戦士（戦斧・鎖帷子）","tool.catalog.fig.warrior","ally","dwarf","#e0b060","axe","chain"),L("エルフの射手（焔の弓）","tool.catalog.fig.archer","ally","elf","#9b8cff","firebow","larmor"),L("ノームの魔道士（魔道書）","tool.catalog.fig.mage","ally","gnome","#7fd06a","grimoire"),L("人間の僧（木の杖・聖印）","tool.catalog.fig.priest","ally","human","#ff9ec4","staff","larmor","life",12),L("竜鱗の重戦士（聖銀の剣・竜鱗の鎧）","tool.catalog.fig.dragoon","ally","dwarf","#e0b060","holyblade","dragonmail","pwr"));const N=new Qt({antialias:!0,preserveDrawingBuffer:!0});N.setSize(128,128);const G=new Zt,rt=new jt(40,1,.05,100),le=new ke(16777215,.85),At=new Mt(16769725,1);At.position.set(3,6,4),G.add(le,At);function Pt(t){G.background=new ne(ee[M].bg),G.add(t);const e=new Et().setFromObject(t),n=e.getCenter(new C),a=e.getSize(new C),o=Math.max(a.x,a.y,a.z)*.62+.24;rt.position.set(n.x+o*1.35,n.y+o*1.15,n.z+o*1.85),rt.lookAt(n),N.render(G,rt);const i=N.domElement.toDataURL();return G.remove(t),i}const Ct=d("cats"),ct=[];function $t(){Ct.innerHTML="",ct.length=0;for(const t of["床・壁・地形","敵","仲間・自機"]){const e=f.filter(o=>o.cat===t),n=document.createElement("h2");n.textContent=`${k(ie[t])}（${e.length}）`,ct.push({el:n,cat:t,n:e.length});const a=document.createElement("div");a.className="grid";for(const o of e){const i=document.createElement("div");i.className="cell";const p=document.createElement("img"),s=document.createElement("div");s.className="nm",s.textContent=it(o),i.append(p,s),i.addEventListener("click",()=>V(o)),a.appendChild(i),o.el=i,o.img=p,o.nmEl=s}Ct.append(n,a)}}function re(){for(const t of ct)t.el.textContent=`${k(ie[t.cat])}（${t.n}）`;for(const t of f)t.nmEl&&(t.nmEl.textContent=it(t));h&&(Ot.textContent=it(h))}function dt(t=!1){for(const e of f)t&&e.cat!=="床・壁・地形"||e.img&&(e.img.src=Pt(e.build()))}const pt=d("stage"),g=new Qt({antialias:!0});g.toneMapping=Me,g.toneMappingExposure=1.22,g.setPixelRatio(Math.min(devicePixelRatio,2)),pt.appendChild(g.domElement);const S=new Zt,B=new jt(42,1,.05,200),H=new Ee(16777215,2236962,.8),I=new Mt(16769725,1);I.position.set(3,4.2,2.4);const O=new Mt(8229565,.3);O.position.set(-2.6,1.4,-1.8);const D=new Le(16761470,0,14,2);S.add(D),S.add(H,I,O);const ce=new Se(8,8,3753310,2305086);S.add(ce);let z=.62,w=.42,y=4;const q=new C(0,.6,0);function Z(){const t=ee[M],e=Ce(t);S.background=new ne(t.bg),H.color.setHex(e.hemiSky),H.groundColor.setHex(e.hemiGround),I.color.setHex(e.sunCol),O.color.setHex(e.fillCol),D.color.setHex(e.heroCol),E==="live"?(H.intensity=e.hemiI,I.intensity=e.sunI,O.intensity=e.fillI,D.intensity=e.heroI,St(e.actFill,e.actFillI)):E==="bright"?(H.intensity=.85,I.intensity=1.05,O.intensity=.3,D.intensity=0,St(e.actFill,.1)):(H.intensity=.09,I.intensity=.1,O.intensity=.05,D.intensity=0,St(0,0))}function Ht(){const t=pt.clientWidth,e=pt.clientHeight;g.setSize(t,e),B.aspect=t/e,B.updateProjectionMatrix()}m.own(window,"resize",Ht);function de(t){const e=new Et().setFromObject(t),n=e.getCenter(new C),a=e.getSize(new C);q.copy(n),y=Math.max(a.x,a.y,a.z)*1.15+.6,D.position.set(n.x+.4,1.9,e.max.z+1.3)}let j=!1,mt=0,ut=0;g.domElement.addEventListener("pointerdown",t=>{t.pointerType!=="touch"&&(j=!0,mt=t.clientX,ut=t.clientY,g.domElement.setPointerCapture(t.pointerId))}),g.domElement.addEventListener("pointermove",t=>{t.pointerType==="touch"||!j||(z+=(t.clientX-mt)*.008,w=Math.min(1.35,Math.max(-.2,w+(t.clientY-ut)*.006)),mt=t.clientX,ut=t.clientY)}),g.domElement.addEventListener("pointerup",t=>{t.pointerType!=="touch"&&(j=!1)}),g.domElement.addEventListener("wheel",t=>{t.preventDefault(),y=Math.min(40,Math.max(.8,y*(t.deltaY>0?1.08:.93)))},{passive:!1});let T=null;const It=t=>Math.min(1.35,Math.max(-.2,t));Qe(g.domElement,{strokeStart(t,e){T={x:t,y:e}},strokeMove(t,e){T&&(z+=(t-T.x)*.008,w=It(w+(e-T.y)*.006)),T={x:t,y:e}},strokeEnd(){T=null},strokeCancel(){T=null},orbit(t,e){z+=t*.008,w=It(w+e*.006)},orbitEnd(){},pinch(t){y=Math.min(40,Math.max(.8,y/t))},undoTap(){},redoTap(){},longPress(){}});const Ot=d("title"),Dt=d("hint"),pe=d("dressrow"),me=d("animrow");function ht(t){c&&S.remove(c),bt(),u=t,c=new kt,c.add(t),S.add(c),de(t)}function V(t){var e;h=t;for(const n of f)(e=n.el)==null||e.classList.toggle("sel",n===t);Ot.textContent=it(t),Dt.innerHTML=t.hint.replace("THEME",M),pe.hidden=!t.dress,me.style.visibility=t.anim?"visible":"hidden",t.dress&&ue(t.actor),ht(t.build())}const tt=d("drace"),W=d("dweapon"),U=d("darmor"),X=d("dacc"),ft=d("dpie"),gt=d("dhero");function et(t,e){const n=t.value;t.innerHTML=e.map(a=>`<option value="${a.v}">${a.t}</option>`).join(""),n&&[...t.options].some(a=>a.value===n)&&(t.value=n)}function Rt(){const t=(e,n)=>`${k(e)}：${n}`;et(tt,Object.entries(Je).map(([e,n])=>({v:e,t:t("tool.catalog.race",$(n.name))}))),et(W,[{v:"",t:t("slot.weapon",k("tool.catalog.none"))},...ln.map(e=>({v:e.id,t:t("slot.weapon",$(e.name))}))]),et(U,[{v:"",t:t("slot.armor",k("tool.catalog.none"))},...rn.map(e=>({v:e.id,t:t("slot.armor",$(e.name))}))]),et(X,[{v:"",t:t("slot.accessory",k("tool.catalog.none"))},...cn.map(e=>({v:e.id,t:t("slot.accessory",$(e.name))}))])}Rt();function ue(t){var e,n,a,o,i,p,s;tt.value=t.race??"human",W.value=((n=(e=t.equipment)==null?void 0:e.weapon)==null?void 0:n.id)??"",U.value=((o=(a=t.equipment)==null?void 0:a.armor)==null?void 0:o.id)??"",X.value=((p=(i=t.equipment)==null?void 0:i.accessory)==null?void 0:p.id)??"",ft.checked=(((s=t.stats)==null?void 0:s.pie)??0)>=10,gt.checked=t.kind==="hero"}function he(){const t=h;if(!(t!=null&&t.dress)||!t.actor)return;const e=t.actor;e.race=tt.value,e.equipment={weapon:W.value?F(W.value):void 0,armor:U.value?F(U.value):void 0,accessory:X.value?F(X.value):void 0},e.stats={...e.stats,pie:ft.checked?12:7},e.kind=gt.checked?"hero":"ally",ht(t.build()),t.img&&(t.img.src=Pt(t.build()))}for(const t of[tt,W,U,X,ft,gt])t.addEventListener("change",he);function bt(){var e,n,a;x&&((e=x.parent)==null||e.remove(x),x.material.dispose(),x=null),b&&((n=b.parent)==null||n.remove(b),b.material.dispose(),b=null),c&&(c.position.set(0,0,0),c.rotation.set(0,0,0),c.scale.set(1,1,1),c.quaternion.identity());const t=(a=u==null?void 0:u.children)==null?void 0:a[0];t!=null&&t.material&&(t.material.transparent=!1,t.material.opacity=1,t.material.needsUpdate=!0),v=null}function _t(t){var a,o,i,p;bt();const e=(((a=h==null?void 0:h.actor)==null?void 0:a.size)??1)>=2,n=t==="hit"?300:t==="death"?e?900:620:Ae[t];if(v={kind:t,t0:performance.now(),dur:n},t==="hit"){const s=(i=(o=u==null?void 0:u.children)==null?void 0:o[0])==null?void 0:i.geometry;s&&(x=new ot(s,new Lt({color:16777215,transparent:!0,opacity:.7,depthWrite:!1,blending:te})),x.scale.set(1.02,1.02,1.02),u.add(x))}if(t==="cast"){const s=new Et().setFromObject(u),r={fire:16747066,ice:10476799,earth:14198858,holy:16771496,poison:9428074}[((p=h==null?void 0:h.actor)==null?void 0:p.element)??""]??14202111;b=new ot(new Pe(.5),new Lt({color:r,transparent:!0,opacity:.9,depthWrite:!1,blending:te})),b.position.set(0,s.max.y+.3,0),b.scale.setScalar(.02),c.add(b)}}l.querySelectorAll("#animrow [data-anim]").forEach(t=>t.addEventListener("click",()=>_t(t.dataset.anim))),d("spin").addEventListener("click",t=>{J=!J,t.currentTarget.classList.toggle("on",J)});let nt=!1,A=0,P=0,Ft=0;function Nt(t){nt=t,d("walk").classList.toggle("on",t)}d("walk").addEventListener("click",()=>Nt(!nt));function fe(t){var Y,Yt,Kt,Jt;const e=Math.min(.05,(t-(Ft||t))/1e3);Ft=t;const n=(Y=u==null?void 0:u.children)==null?void 0:Y[0],a=n==null?void 0:n.material;if(!((Yt=a==null?void 0:a.userData)!=null&&Yt.gaitA)||!(h!=null&&h.actor))return;const o=qe(h.actor),i=Math.PI/(o.dur/1e3);if(nt)A+=i*e,P=Math.min(1,P+e/.08);else{const R=Math.ceil(A/Math.PI-1e-4)*Math.PI;P>0&&A<R?A=Math.min(R,A+i*e):P=Math.max(0,P-e/.16)}const p=o.hover?o.hover*(.5+.5*Math.sin(t*.0016)):0,s=o.breath?o.breath*(.5+.5*Math.sin(t*.0021)):0,r=Ve(o,A,P,p,s);a.userData.gaitA.value.set(r.a[0],r.a[1],r.a[2],r.a[3]),a.userData.gaitB.value.set(r.b[0],r.b[1]);for(const R of u.children){const K=(Kt=R.userData)==null?void 0:Kt.sp;if(!K)continue;const _=K.gw??[0,0,0],yt=((Jt=R.userData)==null?void 0:Jt.bk)??1;R.position.set((K.x+r.a[3]*_[2])*yt,(K.y+r.a[2]*(.15+.85*Math.min(Math.abs(_[2]),1))+r.b[0]*Math.max(0,r.b[1]*Math.sign(_[0]))*Math.abs(_[0]))*yt,(K.z+r.a[0]*_[0]+r.a[1]*_[1])*yt)}}const Gt=new C(1,0,0),Bt=new ae,qt=new ae,ge=new C(0,1,0);function be(t){var p;if(!v||!c)return;const e=t-v.t0,n=e/v.dur;if(n>=1){bt();return}if(v.kind==="hit"){const s=We(n);if(c.position.set(0,0,s.kb),c.scale.set(s.sxz,s.sy,s.sxz),x){const r=Math.min(1,e/210);x.material.opacity=e>210?0:.7*(1-r)}return}if(v.kind==="death"){const s=Ge(n);c.quaternion.setFromAxisAngle(Gt,s.ang),c.position.y=-s.sink;const r=(p=u==null?void 0:u.children)==null?void 0:p[0];r!=null&&r.material&&(r.material.transparent=!0,r.material.opacity=s.opacity);return}const{lunge:a,tilt:o,yawOff:i}=Be(v.kind,n);if(c.position.set(0,0,a),Bt.setFromAxisAngle(Gt,o),qt.setFromAxisAngle(ge,i),c.quaternion.copy(Bt).multiply(qt),b&&v.kind==="cast"){const s=Math.min(1,e/260);b.scale.setScalar(.05+.3*s),b.rotation.y+=.1,b.material.opacity=.9*(.45+.55*s)}}d("theme").addEventListener("change",t=>{M=t.target.value,Z(),dt(!0),h&&(Dt.innerHTML=h.hint.replace("THEME",M),h.cat==="床・壁・地形"&&ht(h.build()))});function vt(){const t=d("light");t.textContent=k(`tool.common.light.${E}`),t.classList.toggle("on",E!=="dark")}d("light").addEventListener("click",()=>{E=E==="live"?"bright":E==="bright"?"dark":"live",vt(),Z()});function Vt(t){J&&!j&&(z+=.006),be(t),fe(t),B.position.set(q.x+y*Math.sin(z)*Math.cos(w),q.y+y*Math.sin(w),q.z+y*Math.cos(z)*Math.cos(w)),B.lookAt(q),g.render(S,B)}let Wt=0,xt=!1;function Ut(){xt||(Wt=requestAnimationFrame(Ut),Vt(performance.now()))}let at=null;function Xt(t){var n;const e=f.find(a=>a.id===t||a.name===t);return e?(V(e),(n=e.el)==null||n.scrollIntoView({block:"nearest"}),!0):!1}window.cdCat={trigger:_t,select:t=>{const e=f.find(n=>n.id===t||n.name===t);return e&&V(e),(e==null?void 0:e.id)??null},pose:()=>c?{z:c.position.z,y:c.position.y,sy:c.scale.y,qx:c.quaternion.x,anim:(v==null?void 0:v.kind)??null}:null,list:()=>f.map(t=>t.id),step:()=>Vt(performance.now()),walk:t=>Nt(t??!nt),gait:()=>{var e,n,a;const t=(n=(e=u==null?void 0:u.children)==null?void 0:e[0])==null?void 0:n.material;return(a=t==null?void 0:t.userData)!=null&&a.gaitA?{a:t.userData.gaitA.value.toArray(),b:t.userData.gaitB.value.toArray(),phase:A,k:P}:null},view:(t,e,n)=>{z=t,w=e,n!=null&&(y=n)},light:t=>{E=t,Z()}};const ve=Ze(()=>{re(),Rt(),vt()});$t(),Z(),vt(),Ht(),dt(),V(f.find(t=>t.id==="mon:ドラゴン")??f[0]),Ut();const wt=m.world();return wt!==tn&&(async()=>{try{const t=await fetch(`/packs/${wt.replace("/","--")}.json`);if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=Xe(await t.json());if(xt)return;Ye(e.monsters.length?e.monsters:null),e.models.length&&ze(e.models.map(n=>({id:n.id,name:n.name,vox:nn(n),glow:en(n)}))),e.parts.length&&Te(e.parts.map(an)),Tt(),$t(),dt(),at&&Xt(at)||V(f.find(n=>n.cat==="敵")??f[0]),at=null}catch(t){console.warn(`world pack（${wt}）の読込に失敗＝旗艦の台帳で表示`,t)}})(),{applyParams(t){const e=t.get("sel");e&&(Xt(e)||(at=e))},dispose(){xt=!0,cancelAnimationFrame(Wt),ve();try{g.dispose(),g.forceContextLoss(),g.domElement.remove()}catch{}try{N.dispose(),N.forceContextLoss()}catch{}delete window.cdCat}}}};export{Mn as catalogPanel};
