import{_ as U,r as dt,g as j,d as pt,a as ct,b as ut,c as mt,e as ft,f as ht,h as bt,i as vt}from"./dungeon-CzQMf0gi.js";import{p as gt}from"./gamepack-Ch4DClsv.js";import{C as F}from"./tables-B68AojDj.js";import{T as xt}from"./tables-doc-DJe4PGR4.js";import{f as J,p as yt,a as wt,g as V,b as R,u as $t,E as kt,s as Lt,o as Tt,t as St,d as K}from"./tuner-core-BOPz8p1v.js";import{r as _t}from"./tool-shelf-CPrJ-OK1.js";import{o as Mt}from"./studio-C4l3Mpju.js";import{b as Pt,t as o}from"./i18n-D_93wjAr.js";import"./preload-helper-Dp1pzeXC.js";import"./dungeon-types-JT-53Zyi.js";import"./voxmodel-BixVuI7N.js";import"./schemas-BBGxizon.js";import"./creator-auth-q666652w.js";const jt=`<!-- ============================================================
...
`,c=g=>g.replace(/[&<>"]/g,S=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[S]),Z=()=>new Date().toISOString().replace(/\.\d+Z$/,"Z");try{const g=Object.assign({"../../tenants/masaru/comduct/prefabs/interior-craft.json":bt,"../../tenants/masaru/comduct/prefabs/interior-equip.json":ht,"../../tenants/masaru/comduct/prefabs/interior-heal.json":ft,"../../tenants/masaru/comduct/prefabs/interior-recruit.json":mt,"../../tenants/masaru/comduct/prefabs/interior-shop.json":ut,"../../tenants/masaru/comduct/prefabs/manifest.json":ct}),S=[];for(const w of Object.keys(g).sort())w.endsWith("manifest.json")||S.push(gt(g[w].default??g[w]));vt(S)}catch(g){console.warn("truth プレハブの読込に失敗（プレハブ無しの束見で継続）",g)}const zt={tuning:F.tuning,gen:F.genParams,gim:F.gimmicks},qt={id:"tuner",async mount(g,S){const{wapi:w,postJson:H}=S.api;g.innerHTML=jt,Pt(g);const i=a=>g.querySelector(`#${a}`);function b(a,t=!1){const e=i("msg");e.textContent=a,e.style.color=t?"#ff7a6e":"#7fd17f"}let p=J(),x="curve",$="trap",u=3,O={};function C(){return Tt(p)}const D="cdTunerW2";function M(){try{sessionStorage.setItem(D,JSON.stringify({v:1,draft:p,tab:x,selGim:$,depth:u,seed:i("seedbase").value,count:i("count").value,label:i("savelabel").value}))}catch{}}function Y(){var a,t;try{const e=sessionStorage.getItem(D);if(!e)return!1;const n=JSON.parse(e);return n.v!==1||!((a=n.draft)!=null&&a.genParams)||!((t=n.draft)!=null&&t.gimmicks)?!1:(p=n.draft,x=n.tab??"curve",$=n.draft.gimmicks[n.selGim]?n.selGim:"trap",u=Math.max(1,Math.min(30,n.depth|0||3)),i("depth").value=String(u),i("depthv").textContent=`${u}F`,n.seed&&(i("seedbase").value=n.seed),n.count&&(i("count").value=n.count),n.label&&(i("savelabel").value=n.label),!0)}catch{return!1}}const f=(a,t,e,n,s=1,m="num")=>{const r=a.split(".").reduce((d,k)=>d==null?void 0:d[k],zt);return`<input class="${m}${typeof r=="number"&&r!==t?" chg":""}" data-f="${a}" type="number" value="${t}" min="${e}" max="${n}" step="${s}" />`};function v(){const a=i("form");if(x==="curve"){const n=p.genParams,s=V(n,u),m=Object.keys(p.gimmicks).map(r=>{const l=p.gimmicks[r];return`<tr data-gim="${r}" class="${r===$?"sel":""}">
          ...
          <td><input class="wide" data-f="pack.${l}.units" type="text" value="${c($t(r.units))}" /></td>
